...
'Exakt 90ms warten (nicht ‰ndern, oder I2C BUS initialisiert nicht richtig!)
DoEvents
Sleep (90)
...
Out = IO1.Out(&H37A, 2)     'SCL high
Out = IO1.Out(&H37A, 3)     'SCL low
Out = IO1.Out(&H37A, 1)     'Bit0 = 1   'Bit0:  0 = Master schreibt anschlieﬂend (Master writes)
Out = IO1.Out(&H37A, 0)     'SCL high   '       1 = Master liest anschlieﬂend (Master reads)
Out = IO1.Out(&H37A, 1)     'SCL low
